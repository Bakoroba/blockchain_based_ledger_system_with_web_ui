...
input_sender = st.text_input("Enter the name of the sender")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
input_receiver = st.text_input("Enter the name of the receiver")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
input_amount = st.text_input("Enter the amount to send")
